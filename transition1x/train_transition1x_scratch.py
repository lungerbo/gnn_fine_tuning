#!/usr/bin/env python3
# Training script: compact and focused on the standard training flow.
...
if __name__ == "__main__":
    args = parse_args()
    tag = f"t1x_gfm_full_{args.fraction}_{os.path.basename(args.split_dir)}_seed{args.seed}"
    setup_log(tag)
    ...
    # Load checkpoint weights (non-strict)
